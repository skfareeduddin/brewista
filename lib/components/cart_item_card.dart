...
class CartItemMobileView extends StatefulWidget {
  ...
  @override
  State<CartItemMobileView> createState() => _CartItemMobileViewState();
}

class _CartItemMobileViewState extends State<CartItemMobileView> {
  int quantity = 1;
...
class CartItemDesktopView extends StatefulWidget {
  const CartItemDesktopView({
    super.key,
    required this.widget,
    required this.quantity,
    required this.coffee,
  ...
  @override
  State<CartItemDesktopView> createState() => _CartItemDesktopView();
}

class _CartItemDesktopView extends State<CartItemDesktopView> {
  int quantity = 1;
